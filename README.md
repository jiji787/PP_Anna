...
## С4-диаграмма контекста / контейнеров / компонентов 
...
graph TD
    ...
    subgraph Internal [Внутренние сервисы системы ОСАГО]
        OsagoApp --> ContractService["Сервис договоров"]
        OsagoApp --> PaymentService["Сервис платежей"]
        OsagoApp --> DocumentService["Сервис документов"]
        
        ContractService --> DB[(Общая база данных)]
        PaymentService --> DB
        DocumentService --> DB
