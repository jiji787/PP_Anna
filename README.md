...
### 30.06.2026 (вт) – День 22: Документация и онбординг-гайд

**Что сделано:**
- В `README.md` добавлен раздел «Установка и запуск проекта» с пошаговыми инструкциями для нового разработчика.
...
**Артефакты:**
- Обновлённый [README.md](README.md).
- [TROUBLESHOOTING.md](TROUBLESHOOTING.md) – гайд по устранению проблем.
